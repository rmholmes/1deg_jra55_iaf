...
#PBS -l storage=gdata/hh5+gdata/ik11+gdata/cj50+scratch/v45+scratch/x77+scratch/g40+gdata/e14+scratch/e14+scratch/au06
#PBS -N sync
...
SYNCDIR=/g/data/ik11/outputs/access-om2/1deg_jra55_iaf_era5comparison/
